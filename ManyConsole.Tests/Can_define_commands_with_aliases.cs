...
namespace ManyConsole.Tests
{
    public class Can_define_commands_with_aliases : GivenWhenThenFixture
    {
        ...
        public class CommandWith2Aliases : ConsoleCommand<DefaultCommandResult, DefaultCommandSettings>
        {
        ...
        private string run_command_with_parameters(string[] parameters)
        {
            return arrange(delegate
            {
                ...
                ConsoleCommandDispatcher<DefaultCommandResult, DefaultCommandSettings>.DispatchCommand(new CommandWith2Aliases(), parameters, sw);
