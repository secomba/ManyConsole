...
namespace ManyConsole.Tests
{
    public class Can_consume_variable_number_of_arguments : GivenWhenThenFixture
    {
        ...
        public class CommandWithAtLeast2Parameters : ConsoleCommand<DefaultCommandResult, DefaultCommandSettings>
        {
        ...
        public class CommandWith2To5Parameters : ConsoleCommand<DefaultCommandResult, DefaultCommandSettings>
        {
        ...
        private string run_command_with_parameters(string[] parameters)
        {
            return arrange(delegate
            {
                ...
                ConsoleCommandDispatcher<DefaultCommandResult, DefaultCommandSettings>.DispatchCommand(
                    new IConsoleCommand<DefaultCommandResult, DefaultCommandSettings>[] {new CommandWithAtLeast2Parameters(),
